...
export class HomeComponent implements OnInit {
    ...
    public setFlickrImages(boundingBox: BoundingBoxModel) {
        ...
        this.flickrGateway.getPhotosForBoundedLocation(
            ...
            response.photos.forEach(photo => this.setPhotoDetails(photo));
        });
    }
    ...
    private setPhotoDetails(photo: PhotoModel) {
        this.flickrGateway.getDetailsForPhoto(photo)
            .subscribe((photoWithInfoDto: PhotoWithInfoDto) => {
